...
//         return res
//           .status(500)
//           .json("los requerimientos del administrador es requerido");
//       }
...
//         return res
//           .status(404)
//           .json(`No existe el adminsitrador con el id: ${id}`);
//       }
//       return res.status(200).json(administrador);
//     } catch (error) {
//       return res.status(500).json(error.message);
...
//         return res
//           .status(500)
//           .json(`los requerimientos del administrador son requeridos`);
//       }
